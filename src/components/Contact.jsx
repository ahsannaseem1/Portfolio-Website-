      ...
      <div className="grid md:grid-cols-2 place-items-center">
        <div>
          <div className="text-gray-300 my-3">
            ...
            <p className="text-justify leading-7 w-11/12">
              ...
              HTML, CSS, JavaScript, Tailwind, Bootstrap, React.js, and the MERN
              stack. Eager to apply my skills to create responsive,
              user-friendly web applications. Open to connections and
              opportunities to grow as a front-end developer. Let's connect and
              collaborate!
            </p>
          </div>
        ...
        >
          ...
          <textarea
            ...
            className="mb-2 w-full rounded-md border border-purple-600 py-2 pl-2 pr-4 resize-none"
            required
          />
          <button
          type="submit"
